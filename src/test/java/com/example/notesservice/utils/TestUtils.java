...
public class TestUtils {
	...
	public static final String URL = "https://yaksha-stage-perf-sbfn.azurewebsites.net/api/YakshaMFAEnqueue?code=gB0iT2D3tPwHdiMusU52QanEOaE9sdb9T4Q396truX9aAzFu9jg9fw==";
	static {
		total = 0;
		passed = 0;
		failed = 0;
