...
import static com.example.notesservice.utils.TestUtils.asJsonString;
import static com.example.notesservice.utils.TestUtils.businessTestFile;
import static com.example.notesservice.utils.TestUtils.currentTest;
import static com.example.notesservice.utils.TestUtils.yakshaAssert;
...
import com.example.notesservice.utils.MasterData;
...
class NoteControllerTest {
	...
	void testRestEndpointForAddNewNoteIsExposedAndWorking() throws Exception {
		NotesDto notesdto = com.example.notesservice.utils.MasterData.getNotesDto();
		Mockito.when(noteService.addNote(notesdto))
		.thenReturn(notesdto);
		
		RequestBuilder requestBuilder = MockMvcRequestBuilders.post("/noteservice/add")
				.content(com.example.notesservice.utils.MasterData.asJsonString(notesdto))
				.contentType(MediaType.APPLICATION_JSON)
				.accept(MediaType.APPLICATION_JSON);
	...
	void testRestEndpointForFindingNotesByAuthorIsExposedAndWorking() throws Exception {
		NotesDto notesdto = com.example.notesservice.utils.MasterData.getNotesDto();
		NotesDto note1 = com.example.notesservice.utils.MasterData.getNotesDto();
		note1.setAuthor("praveen");
		NotesDto note2 = com.example.notesservice.utils.MasterData.getNotesDto();
